...
internal `vision.types` can evolve without breaking external clients.
"""
from __future__ import annotations

from pydantic import BaseModel, Field

from vision.types import Detection, VerifiedObjects
...
class AnalyzeRequest(BaseModel):
  ...
  def to_domain(self) -> VerifiedObjects:
