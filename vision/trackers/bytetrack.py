...
class ByteTrackTracker(BaseTracker):
    ...
    def update(self, detections: List[Detection], frame_id: int) -> TrackResult:
        ...
        # Detect lost tracks (any in active_tracks that were not updated)
    ...
    def reset(self) -> None:
        logger.info("Resetting ByteTrackTracker")
        self.next_id = 1
        self.active_tracks.clear()
        self.track_lifetimes.clear()

    def shutdown(self) -> None:
        logger.info("Shutting down ByteTrackTracker")
